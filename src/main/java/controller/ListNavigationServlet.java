	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(act ==null) {
			...
			try{
				...
				GameDetails listToDelete =dao.searchForGameDetailsById(tempId);
			...
			try{
				Integer tempId = Integer.parseInt(request.getParameter("id"));
				GameDetails listToEdit = dao.searchForGameDetailsById(tempId);
				...
				GameItemHelper daoForItems = new GameItemHelper();
