...
<html>
	...
	<body>
		<form action="editListDetailsServlet" method="post">
			...
			List Name: <input type="text" name ="gameListName" value="${listToEdit.gameListName}">
			<br />
			Added date: <input type="text" name="month" placeholder="mm" size="4" value="${month}"> 
			<input type="text" name="day" placeholder="dd" size="4" value="${date}">
			, 
			<input type="text" name="year" placeholder="yyyy" size="4" value="${year}">
			Player Name: <input type="text" name ="playerName" value="${listToEdit.player.playerName}">
			<br />
			Available Items:<br />
